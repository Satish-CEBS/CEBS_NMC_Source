    ...
    useEffect(() => {
        if (chatOpen) {
            ...
            if (!existingIframe) {
                ...
                iframe.src = 'https://docsbot.ai/iframe/KhRF8F5KH2P0HlN7RW97/4EZqJ7PPGv0XpAhkDkd8';
                iframe.width = '400';
                iframe.height = '500';
    ...
    return (
        <>
            <footer className="main-footer">
                <p>©2025 <strong>CEBS Worldwide</strong>. All rights reserved. Unauthorized use is prohibited.</p>
            </footer>

            {/* Floating AI Button */}
            {!chatOpen && (
                <button className="floating-ai-button" onClick={() => setChatOpen(true)}>
            ...
            {chatOpen && (
                <div className="floating-ai-window" id="floating-ai-container">
                    <button className="ai-close-button" onClick={closeChat}>×</button>
                </div>
            )}
        </>
    );
