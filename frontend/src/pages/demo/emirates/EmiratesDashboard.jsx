...
const emiratesList = ['All Emirates', 'Abu Dhabi', 'Dubai', 'Sharjah', 'Ajman', 'Umm Al Quwain', 'Ras Al Khaimah', 'Fujairah'];
...
const EmiratesDashboardPage = () => {
    ...
    const filteredArrival = selectedEmirate === 'All Emirates' ? Object.entries(arrivalData).map(([key, val]) => ({ emirate: key, count: val })) : [{ emirate: selectedEmirate, count: arrivalData[selectedEmirate] || 0 }];
        ...
        <div className="emirates-dashboard-wrapper">
            ...
            <div className="emirates-dashboard-content">
                ...
                <div className="filter-bar">
                    ...
                    <button onClick={exportPDF}><DownloadIcon fontSize="small" /> Export PDF</button>
                </div>
                ...
                <div className="cards-container" ref={exportRef}>
                    <div className="chart-card">
                        ...
                        <p className="chart-description">Shows number of vessels handled by each Emirate.</p>
                    </div>
                        ...
                        <PieChart width={200} height={200}>
                            ...
                            >
                                {complianceData.map((entry, index) => (
                                    <Cell key={`slice-${index}`} className={`pie-slice-color-${index}`} />
                                ))}
                            </Pie>
                            <Tooltip />
                        </PieChart>
                        <p className="chart-description">Percentage of vessels with complete documentation.</p>
                    </div>
                    ...
                    <div className="chart-card">
                        ...
                        <p className="chart-description">Month-wise port activity trend across Emirates.</p>
                    </div>
                </div>
                <Footer />
            </div>
